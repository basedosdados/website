...
class BdmTable(Resource):
    ...
    observation_level: Optional[
        Set[ObservationLevel]
    ] = OBSERVATION_LEVEL_FIELD  # Required for tier 1
    ...
    temporal_coverage: Optional[
        TemporalCoverage
    ] = TEMPORAL_COVERAGE_FIELD  # Required for tier 1
    update_frequency: Optional[
        UpdateFrequencyEnum
    ] = UPDATE_FREQUENCY_FIELD  # Required for tier 1
