...
class LastUpdated(BaseModel):
    # fmt: off
    metadata: Optional[datetime]  = Field(title="Última atualização: metadados",user_input_hint=["Última atualização: metadados"])
    data     : Optional[datetime] = Field(title="Última atualização: dados",user_input_hint=["Última atualização: dados"])
    release  : Optional[datetime] = Field(title="Último lançamento: dados originais",user_input_hint=["Último lançamento: dados originais"])
    # fmt: on
