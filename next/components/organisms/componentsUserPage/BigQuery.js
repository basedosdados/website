import { Stack, Box, Text, FormControl } from "@chakra-ui/react";
...
export default function BigQuery({ userInfo }) {
  ...
  const [emailGcp, setEmailGcp] = useState(
    userInfo?.gcpEmail || userInfo?.email,
  );
  ...
  return (
    <Stack spacing={0}>
      ...
      <FormControl
        maxWidth={{ base: "100%", lg: "480px" }}
        isInvalid={!!errors.emailGcp}
      ...
      >
        ...
        />
        <ErrorMessage>{errors.emailGcp}</ErrorMessage>
      </FormControl>
