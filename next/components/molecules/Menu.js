    ...
    return ( <
        ...
        display = {
            ...
            userData ? ( <
                ...
                Link style = {
                    { fontSize: "12px" } }
                href = { `/user/${userData.name}` } > { userData.fullname } <
                /Link> <
                /HStack>
            ) : ( <
                >
...
export default function Menu({ pages = [] }) {
    ...
    return ( <
        ...
        Box display = {
            { base: "flex", lg: "none" } } >
        <
        FontAwesomeIcon onClick = { menuDisclosure.onOpen }
        style = {
            {
                minWidth: "30px",
                minHeight: "30px",
        ...
        href = "/" >
        <
        BDLogoImage transform = "translateX(-20%)"
        height = "40px"
        widthImage = "80px" /
        >
        <
