...
export default function CheckEmail() {
  ...
  async function handleEmailConfirm() {
    ...
    const getIdUser = await fetch(`/api/user/getIdUser?p=${btoa(email)}`, {
      method: "GET",
    }).then((res) => res.json());
    ...
    <MainPageTemplate display="flex" justifyContent="center" cleanTemplate>
      ...
      >
        ...
        <Stack spacing="16px">
          ...
          <BodyText typography="large" textAlign="center" fontWeight="500">
            {email}
          </BodyText>
        </Stack>
        ...
        <Stack spacing="8px">
          ...
          >
            {forwardingDisabled
              ? t("checkEmail.waitSeconds", { count })
