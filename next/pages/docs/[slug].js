...
import { getAllDocs, getDocsBySlug, serializeDoc } from '../api/docs'
  ...
  return (
    <Box>
      {schemeCategories.map((category, index) => {
        ...
        return (
          <Box key={index}>
            <LabelText typography="small" marginY="8px">
              {category}
            </LabelText>

            {docsInCategory.map(doc => (
              <Box key={doc.slug}>
                <Link width="100%" href={`/docs/${doc.slug}`}>
                  <LabelText
...
const LANGS_SUPPORTED = ['sql', 'python', 'r', 'bash', 'sh', 'stata', 'markdown', 'md']
...
export const mdxComponents = {
  ...
  blockquote: props => (
    <Box as="blockquote" position="relative" display="flex" flexDirection="row" margin="8px 0 16px">
      <Box
        position="absolute"
        left={0}
        width="40px"
      ...
      >
        ...
        <BodyText position="relative" top="2px" typography="small" as="span" {...props} />
      </Stack>
    </Box>
  ),
  a: props => (
  ...
  p: props => <BodyText typography="small" as="p" color="#464A51" marginBottom="4px" {...props} />,
  code: props => (
    <Text
      as="code"
  ...
  table: props => (
    <TableContainer border="1px solid #DEDFE0" borderRadius="20px">
      <Table variant="simple" {...props} />
    </TableContainer>
  ),
  thead: props => <Thead backgroundColor="#F7F7F7" {...props} />,
  ...
  Button: props => (
    <Button margin="16px 0 8px" onClick={() => window.open(props.href, '_blank')}>
      {props.text}
    </Button>
  ),
  Spacing: props => <Box {...props} />,
  Warning: props => (
    <Box as="blockquote" position="relative" display="flex" flexDirection="row" margin="16px 0">
      <Box
        position="absolute"
        left={0}
        width="40px"
      ...
      <Stack
        ...
        zIndex="10"
      >
        <WarningIcon width="20px" height="20px" padding="2px" fill="#F9C50B" />
        <BodyText position="relative" top="2px" typography="small" as="span" {...props} />
      </Stack>
    </Box>
  ),
  Image: props => (
    <Box as="figure" marginY="16px" boxShadow="0 1.6px 16px 0 rgba(100, 96, 103, 0.16)">
      ...
      >
        ...
        >
          ...
          <Box display="flex" flexDirection="column" gap="8px">
            <BodyText position="relative" top="2px" typography="small" as="span" {...tip.props} />
            {body && (
              <BodyText
                position="relative"
                top="2px"
  ...
  Blockquote: ({ children }) => {
    ...
    return (
      ...
      >
        ...
        {figcaption ? <BodyText marginTop="16px" color="#71757A" {...figcaption.props} /> : null}
      </Box>
    )
  }
}
...
export default function Docs({ allDocs, slug, locale, mdxSource, headings }) {
  ...
  return (
    <MainPageTemplate width="100%" maxWidth="1440px" margin="0 auto" paddingX="24px">
      <Head>
        <title>
      ...
      >
        {allDocs && allDocs.length > 0 && (
          <Box
            ...
            paddingRight="26px"
          >
            <Toc allDocs={allDocs} slug={slug} headings={headings} locale={locale} />
          </Box>
        )}
