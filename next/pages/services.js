...
function Slogan() {
  ...
  return (
    ...
    >
      ...
      <TitleText typography="large" color="#71757A" textAlign="center">
        {t("slogan.description")}
      </TitleText>
      <Link href="/contact-consulting" target="_self">
        <LabelText
          typography="x-large"
          display="flex"
          alignItems="center"
  ...
  return (
    ...
    >
      <Box
        ...
        alignItems="center"
      >
        <CheckIcon width="28px" height="28px" fill="#2B8C4D" />
        {benefits && (
          <BodyText typography="large" fontWeight="500" color="#464A51">
            {benefits}:
          </BodyText>
        )}
      </Box>
...
function BorderBox({ title, children }) {
  return (
    <VStack
      ...
      spacing={4}
    >
      <TitleText typography="small">{title}</TitleText>
...
function WorkflowBox({ order, title, subtitle, children }) {
  ...
  return (
    <VStack
      ...
      spacing={0}
    >
      <TitleText typography="small" textAlign="center">
        {title}
      </TitleText>
      <LabelText
        typography="large"
      ...
      <BodyText color="#464A51" textAlign="center">
        {children}
      </BodyText>
    </VStack>
  );
...
function CaseStudies({ data }) {
  ...
  return (
    <Stack
      ...
      spacing={0}
    >
      <Display typography="small" textAlign="center" paddingBottom="16px">
        {t("caseStudies.title")}
      </Display>
      <TitleText color="#71757A" textAlign="center" paddingBottom="40px">
      ...
      >
        {CaseStudiesPages.length > 0 &&
          CaseStudiesPages.map((elm) => (
            <Stack key={elm.id} width="400px" spacing={0}>
              {/* Imagem banner */}
              <Box
                position="relative"
              ...
              >
                {elm?.summary &&
                  elm?.summary.slice(0, useCheckMobile() ? 160 : 178) + "..."}
              </BodyText>
  ...
  return (
    <MainPageTemplate>
      <Head>
        ...
        <meta property="og:title" content={t("metaTitle")} key="ogtitle" />
      </Head>

      <Stack spacing={0} paddingX="24px" margin="0 auto" alignItems="center">
        <Slogan />
          ...
          {Object.entries(services).map(([k, v]) => (
            <Link href={`#${service_ids[k]}`} key={v}>
              <VStack justify="flex-end">
                ...
                <LabelText typography="x-large">{k}</LabelText>
              </VStack>
            </Link>
          ))}
        </Stack>
        ...
        <VStack
          ...
          spacing={0}
        >
          <Display textAlign="center" paddingBottom="8px">
            {t("dataCapture.title")}
          </Display>
          ...
          <BodyText typography="large" maxWidth="800px" color="#464A51">
        ...
        >
          ...
          <Stack paddingTop="40px">
            ...
            <BoxBenefits>{t("dataAnalysis.examples.example1")}</BoxBenefits>
            <BoxBenefits>{t("dataAnalysis.examples.example2")}</BoxBenefits>
            <BoxBenefits>{t("dataAnalysis.examples.example3")}</BoxBenefits>
          </Stack>
        </VStack>
          ...
          <Stack paddingTop="40px" spacing="40px">
            ...
            >
              ...
              >
                <GridItem>
                  <BorderBox
                    title={t("dataConsulting.areas.infrastructure.title")}
                  >
                ...
                <GridItem>
                  <BorderBox
                    title={t("dataConsulting.areas.programming.title")}
                  >
        ...
        <VStack
          ...
          spacing={0}
        >
          <Display typography="small" textAlign="center" paddingBottom="24px">
            {t("workflow.title")}
          </Display>
          <TitleText maxWidth="800px" color="#71757A" textAlign="center">
          ...
          <Stack spacing={0} width="100%" alignItems="center">
            <WorkflowBox
              order={1}
              title={t("workflow.steps.demand.title")}
              subtitle={t("workflow.steps.demand.subtitle")}
            >
            ...
            <WorkflowBox
              order={2}
              title={t("workflow.steps.planning.title")}
              subtitle={t("workflow.steps.planning.subtitle")}
            >
            ...
            <WorkflowBox
              order={3}
              title={t("workflow.steps.budget.title")}
              subtitle={t("workflow.steps.budget.subtitle")}
            >
            ...
            <WorkflowBox
              order={4}
              title={t("workflow.steps.execution.title")}
              subtitle={t("workflow.steps.execution.subtitle")}
            >
