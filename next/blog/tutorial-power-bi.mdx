...
![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_0.png)
...
![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_1.png)

```
SELECT     pib.id_municipio, --selecionar id do municipio    pop.ano, -- população do muunicipio    pib.PIB / pop.populacao AS pib_per_capita -- calculo do PIB per capitaFROM `basedosdados.br_ibge_pib.municipio` AS pib -- selecionar base de pib dos municipiosJOIN `basedosdados.br_ibge_populacao.municipio` AS pop -- join com a base de populaçãoON pib.id_municipio = pop.id_municipio AND pib.ano = pop.anoLIMIT 100
```

![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_2.png)
...
![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_3.png)
...
![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_4.png)
...
![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_5.png)
...
![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_6.png)
...
```
SELECT     id_municipio,    municipio,    id_uf,    uf,    regiao,FROM `basedosdados.br_bd_diretorios_brasil.municipio`
```
...
![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_7.png)

* Procure pelo `Google BigQuery` -> Conectar

![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_8.png)
...
![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_9.png)
...
![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_10.png)
...
![](https://storage.googleapis.com/basedosdados-website/blog/tutorial-power-bi/image_11.gif)
