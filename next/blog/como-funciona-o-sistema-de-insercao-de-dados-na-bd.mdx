...
date: '2022-01-21T15:00:40.969Z'
categories: []
keywords: []
slug: >-
  /@basedosdados/como-funciona-o-sistema-de-inser%C3%A7%C3%A3o-de-dados-na-bd-61a0fe05c5d5
---
> **Texto produzido por** [**Vinicius**](https://github.com/vncsna) **e** [**Fernanda**](https://github.com/fernandascovino)**, com apoio de** [**Diego**](https://github.com/d116626)**,** [**João**](https://github.com/JoaoCarabetta) **e** [**Caio**](https://github.com/Hellcassius) **do time de Infra da Base dos Dados**

> Data da publicação original: *28/5/2021*

> Adaptação e edição por [Giovane Caruso](https://medium.com/@giovanecaruso)

**TL;DR:** Neste artigo você vai conhecer um pouco sobre como funciona a infraestrutura de inserção de dados da Base dos Dados e como pode melhorar seu portfólio de cientista de dados e/ou desenvolvedor contribuindo com a nossa missão de universalizar o acesso a dados.

![](https://storage.googleapis.com/basedosdados-website/blog/como-funciona-o-sistema-de-insercao-de-dados-na-bd/image_0.jpg)
...
![](https://storage.googleapis.com/basedosdados-website/blog/como-funciona-o-sistema-de-insercao-de-dados-na-bd/image_1.png)
